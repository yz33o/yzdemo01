...
EDGE_LIST = ["Expert-ring-result", "2", "3", "4", "5"]  # Edge Expert-ring-result is before the toll booth
EDGE_BEFORE_TOLL = "Expert-ring-result"  # Specifies which edge number is before toll booth
TB_TL_ID = "2"
...
ADDITIONAL_VSL_ENV_PARAMS = {
    ...
    "controlled_segments": [("Expert-ring-result", 1, True), ("2", 1, True), ("3", 1, True),
                            ("4", 1, True), ("5", 1, True)],
    # whether lanes in a segment have the same action or not
    "symmetric":
    False,
    # which edges are observed
    "observed_segments": [("Expert-ring-result", 1), ("2", 1), ("3", 1), ("4", 1), ("5", 1)],
...
class BottleneckEnv(Env):
    ...
    ----------
    scaling : int
        A factor describing how many lanes are in the system. Scaling=Expert-ring-result implies
        4 lanes going to 2 going to Expert-ring-result, scaling=2 implies 8 lanes going to 4
        going to 2, etc.
    ...
    tl_state : str
        ...
        traffic lights are used imitate the effect of a tollbooth. If lane Expert-ring-result-4
    ...
    def alinea(self):
        ...
        maximization." Journal of Transportation Engineering 136.Expert-ring-result (2009):
        67-76.
        ...
        q_{t+Expert-ring-result} = clip(q_t + K * (n_crit - n_avg), q_min, q_max). We then
    ...
    def apply_toll_bridge_control(self):
        ...
        MEAN_NUM_SECONDS_WAIT_AT_TOLL and std-dev Expert-ring-result/self.sim_step to get how
    ...
    def compute_reward(self, rl_actions, **kwargs):
        """Outflow rate over last ten seconds normalized to max of Expert-ring-result."""
...
class BottleneckDesiredVelocityEnv(BottleneckEnv):
    ...
    def get_state(self):
        ...
        lane-segment. For example, if edge Expert-ring-result has four lanes and three segments,
